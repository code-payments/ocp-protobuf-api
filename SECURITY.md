...
<a name="reporting"></a>
## Reporting security problems in the OCP Protobuf API

Please use this [Report a Vulnerability](https://github.com/code-payments/ocp-protobuf-api/security/advisories/new) link.
