...
// @generated from file messaging/v1/ocp_messaging_service.proto (package ocp.messaging.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
import { Mint } from "../../currency/v1/ocp_currency_service_pb";
import { VerifiedExchangeData } from "../../transaction/v1/ocp_transaction_service_pb";
...
export class OpenMessageStreamRequest extends Message$1<OpenMessageStreamRequest> {
  /**
   * @generated from field: ocp.messaging.v1.RendezvousKey rendezvous_key = 1;
   */
  ...
  static readonly typeName = "ocp.messaging.v1.OpenMessageStreamRequest";
...
/**
 * @generated from message ocp.messaging.v1.OpenMessageStreamResponse
 */
export class OpenMessageStreamResponse extends Message$1<OpenMessageStreamResponse> {
  /**
   * @generated from field: repeated ocp.messaging.v1.Message messages = 1;
   */
  messages: Message[] = [];
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ocp.messaging.v1.OpenMessageStreamResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ocp.messaging.v1.OpenMessageStreamWithKeepAliveRequest
 */
export class OpenMessageStreamWithKeepAliveRequest extends Message$1<OpenMessageStreamWithKeepAliveRequest> {
  /**
   * @generated from oneof ocp.messaging.v1.OpenMessageStreamWithKeepAliveRequest.request_or_pong
   */
  requestOrPong: {
    /**
     * @generated from field: ocp.messaging.v1.OpenMessageStreamRequest request = 1;
     */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ocp.messaging.v1.OpenMessageStreamWithKeepAliveRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ocp.messaging.v1.OpenMessageStreamWithKeepAliveResponse
 */
export class OpenMessageStreamWithKeepAliveResponse extends Message$1<OpenMessageStreamWithKeepAliveResponse> {
  /**
   * @generated from oneof ocp.messaging.v1.OpenMessageStreamWithKeepAliveResponse.response_or_ping
   */
  responseOrPing: {
    /**
     * @generated from field: ocp.messaging.v1.OpenMessageStreamResponse response = 1;
     */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ocp.messaging.v1.OpenMessageStreamWithKeepAliveResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ocp.messaging.v1.PollMessagesRequest
 */
export class PollMessagesRequest extends Message$1<PollMessagesRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ocp.messaging.v1.PollMessagesRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "rendezvous_key", kind: "message", T: RendezvousKey },
    { no: 2, name: "signature", kind: "message", T: Signature },
  ]);
...
/**
 * @generated from message ocp.messaging.v1.PollMessagesResponse
 */
export class PollMessagesResponse extends Message$1<PollMessagesResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ocp.messaging.v1.PollMessagesResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "messages", kind: "message", T: Message, repeated: true },
  ]);
...
/**
 * @generated from message ocp.messaging.v1.AckMessagesRequest
 */
export class AckMessagesRequest extends Message$1<AckMessagesRequest> {
  ...
  /**
   * @generated from field: repeated ocp.messaging.v1.MessageId message_ids = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ocp.messaging.v1.AckMessagesRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "rendezvous_key", kind: "message", T: RendezvousKey },
...
/**
 * @generated from message ocp.messaging.v1.AckMesssagesResponse
 */
export class AckMesssagesResponse extends Message$1<AckMesssagesResponse> {
  /**
   * @generated from field: ocp.messaging.v1.AckMesssagesResponse.Result result = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ocp.messaging.v1.AckMesssagesResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from enum ocp.messaging.v1.AckMesssagesResponse.Result
 */
...
proto3.util.setEnumType(AckMesssagesResponse_Result, "ocp.messaging.v1.AckMesssagesResponse.Result", [
  { no: 0, name: "OK" },
]);

/**
 * @generated from message ocp.messaging.v1.SendMessageRequest
 */
export class SendMessageRequest extends Message$1<SendMessageRequest> {
   ...
   *
   * @generated from field: ocp.messaging.v1.Message message = 1;
   */
  message?: Message;
   ...
   *
   * @generated from field: ocp.messaging.v1.RendezvousKey rendezvous_key = 2;
   */
  rendezvousKey?: RendezvousKey;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ocp.messaging.v1.SendMessageRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ocp.messaging.v1.SendMessageResponse
 */
export class SendMessageResponse extends Message$1<SendMessageResponse> {
  /**
   * @generated from field: ocp.messaging.v1.SendMessageResponse.Result result = 1;
   */
   ...
   * Set if result == OK.
   *
   * @generated from field: ocp.messaging.v1.MessageId message_id = 2;
   */
  messageId?: MessageId;
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ocp.messaging.v1.SendMessageResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from enum ocp.messaging.v1.SendMessageResponse.Result
 */
...
proto3.util.setEnumType(SendMessageResponse_Result, "ocp.messaging.v1.SendMessageResponse.Result", [
  { no: 0, name: "OK" },
 ...
 *
 * @generated from message ocp.messaging.v1.RendezvousKey
 */
export class RendezvousKey extends Message$1<RendezvousKey> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ocp.messaging.v1.RendezvousKey";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message ocp.messaging.v1.MessageId
 */
export class MessageId extends Message$1<MessageId> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ocp.messaging.v1.MessageId";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "value", kind: "scalar", T: 12 /* ScalarType.BYTES */ },
  ]);
 ...
 *
 * @generated from message ocp.messaging.v1.RequestToGrabBill
 */
export class RequestToGrabBill extends Message$1<RequestToGrabBill> {
   ...
   * should be sent.
   *
   * @generated from field: ocp.common.v1.SolanaAccountId requestor_account = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ocp.messaging.v1.RequestToGrabBill";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 * This message type is only initiated by clients.
 *
 * @generated from message ocp.messaging.v1.RequestToGiveBill
 */
...
/**
 * @generated from message ocp.messaging.v1.Message
 */
export class Message extends Message$1<Message> {
   ...
   *
   * @generated from field: ocp.messaging.v1.MessageId id = 1;
   */
  id?: MessageId;
   ...
   *
   * @generated from field: ocp.common.v1.Signature send_message_request_signature = 2;
   */
  sendMessageRequestSignature?: Signature;

  /**
   * @generated from oneof ocp.messaging.v1.Message.kind
   */
  kind: {
    /**
     * @generated from field: ocp.messaging.v1.RequestToGrabBill request_to_grab_bill = 3;
     */
    value: RequestToGrabBill;
    case: "requestToGrabBill";
  } | {
    /**
     * @generated from field: ocp.messaging.v1.RequestToGiveBill request_to_give_bill = 4;
     */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ocp.messaging.v1.Message";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
