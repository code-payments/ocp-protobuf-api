...
// @generated from file common/v1/model.proto (package ocp.common.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
export enum AccountType {
  ...
  /**
   * @generated from enum value: REMOTE_SEND_GIFT_CARD = 2;
   */
  REMOTE_SEND_GIFT_CARD = 2,

  /**
   * @generated from enum value: SWAP = 3;
   */
  SWAP = 3,

  /**
   * @generated from enum value: ASSOCIATED_TOKEN_ACCOUNT = 4;
   */
  ASSOCIATED_TOKEN_ACCOUNT = 4,

  /**
   * @generated from enum value: POOL = 5;
   */
  POOL = 5,
}
// Retrieve enum metadata with: proto3.getEnumType(AccountType)
proto3.util.setEnumType(AccountType, "ocp.common.v1.AccountType", [
  { no: 0, name: "UNKNOWN" },
  { no: 1, name: "PRIMARY" },
  { no: 2, name: "REMOTE_SEND_GIFT_CARD" },
  { no: 3, name: "SWAP" },
  { no: 4, name: "ASSOCIATED_TOKEN_ACCOUNT" },
  { no: 5, name: "POOL" },
]);
...
export class SolanaAccountId extends Message<SolanaAccountId> {
  ...
  static readonly typeName = "ocp.common.v1.SolanaAccountId";
 ...
 *
 * @generated from message ocp.common.v1.SolanaAddressLookupTable
 */
export class SolanaAddressLookupTable extends Message<SolanaAddressLookupTable> {
  ...
  /**
   * @generated from field: repeated ocp.common.v1.SolanaAccountId entries = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ocp.common.v1.SolanaAddressLookupTable";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message ocp.common.v1.Transaction
 */
export class Transaction extends Message<Transaction> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ocp.common.v1.Transaction";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "value", kind: "scalar", T: 12 /* ScalarType.BYTES */ },
  ]);
 ...
 *
 * @generated from message ocp.common.v1.Blockhash
 */
export class Blockhash extends Message<Blockhash> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ocp.common.v1.Blockhash";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "value", kind: "scalar", T: 12 /* ScalarType.BYTES */ },
  ]);
 ...
 *
 * @generated from message ocp.common.v1.Signature
 */
export class Signature extends Message<Signature> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ocp.common.v1.Signature";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "value", kind: "scalar", T: 12 /* ScalarType.BYTES */ },
  ]);
...
export class IntentId extends Message<IntentId> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ocp.common.v1.IntentId";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "value", kind: "scalar", T: 12 /* ScalarType.BYTES */ },
  ]);
 ...
 *
 * @generated from message ocp.common.v1.SwapId
 */
export class SwapId extends Message<SwapId> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ocp.common.v1.SwapId";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "value", kind: "scalar", T: 12 /* ScalarType.BYTES */ },
  ]);
 ...
 *
 * @generated from message ocp.common.v1.Hash
 */
export class Hash extends Message<Hash> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ocp.common.v1.Hash";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "value", kind: "scalar", T: 12 /* ScalarType.BYTES */ },
  ]);
 ...
 *
 * @generated from message ocp.common.v1.UUID
 */
export class UUID extends Message<UUID> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ocp.common.v1.UUID";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "value", kind: "scalar", T: 12 /* ScalarType.BYTES */ },
  ]);
 ...
 *
 * @generated from message ocp.common.v1.Request
 */
export class Request extends Message<Request> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ocp.common.v1.Request";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
 ...
 *
 * @generated from message ocp.common.v1.Response
 */
export class Response extends Message<Response> {
  /**
   * @generated from field: ocp.common.v1.Response.Result result = 1;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ocp.common.v1.Response";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from enum ocp.common.v1.Response.Result
 */
...
proto3.util.setEnumType(Response_Result, "ocp.common.v1.Response.Result", [
  { no: 0, name: "OK" },
  { no: 1, name: "ERROR" },
]);

/**
 * @generated from message ocp.common.v1.ServerPing
 */
export class ServerPing extends Message<ServerPing> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ocp.common.v1.ServerPing";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message ocp.common.v1.ClientPong
 */
export class ClientPong extends Message<ClientPong> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "ocp.common.v1.ClientPong";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "timestamp", kind: "message", T: Timestamp },
  ]);
