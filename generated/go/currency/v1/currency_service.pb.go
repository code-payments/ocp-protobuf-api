...
var file_currency_v1_currency_service_proto_rawDesc = []byte{
	...
	0x01, 0x02, 0x10, 0x01, 0x52, 0x07, 0x6f, 0x6d, 0x6e, 0x69, 0x62, 0x75, 0x73, 0x22, 0xeb, 0x04,
	...
	,
	...
	0x6e, 0x73, 0x65, 0x42, 0x7a, 0x0a, 0x1b, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x64, 0x65, 0x69,
...
var file_currency_v1_currency_service_proto_goTypes = []interface{}{
	...
	(*GetAllRatesRequest)(nil),      // 2: ocp.currency.v1.GetAllRatesRequest
	(*GetAllRatesResponse)(nil),     // 3: ocp.currency.v1.GetAllRatesResponse
	(*GetMintsRequest)(nil),         // 4: ocp.currency.v1.GetMintsRequest
	(*GetMintsResponse)(nil),        // 5: ocp.currency.v1.GetMintsResponse
	(*Mint)(nil),                    // 6: ocp.currency.v1.Mint
	(*VmMetadata)(nil),              // 7: ocp.currency.v1.VmMetadata
	(*LaunchpadMetadata)(nil),       // 8: ocp.currency.v1.LaunchpadMetadata
	nil,                             // 9: ocp.currency.v1.GetAllRatesResponse.RatesEntry
	nil,                             // 10: ocp.currency.v1.GetMintsResponse.MetadataByAddressEntry
...
var file_currency_v1_currency_service_proto_depIdxs = []int32{
	11, // 0: ocp.currency.v1.GetAllRatesRequest.timestamp:type_name -> google.protobuf.Timestamp
	0,  // 1: ocp.currency.v1.GetAllRatesResponse.result:type_name -> ocp.currency.v1.GetAllRatesResponse.Result
	11, // 2: ocp.currency.v1.GetAllRatesResponse.as_of:type_name -> google.protobuf.Timestamp
	9,  // 3: ocp.currency.v1.GetAllRatesResponse.rates:type_name -> ocp.currency.v1.GetAllRatesResponse.RatesEntry
	12, // 4: ocp.currency.v1.GetMintsRequest.addresses:type_name -> ocp.common.v1.SolanaAccountId
	1,  // 5: ocp.currency.v1.GetMintsResponse.result:type_name -> ocp.currency.v1.GetMintsResponse.Result
	10, // 6: ocp.currency.v1.GetMintsResponse.metadata_by_address:type_name -> ocp.currency.v1.GetMintsResponse.MetadataByAddressEntry
	12, // 7: ocp.currency.v1.Mint.address:type_name -> ocp.common.v1.SolanaAccountId
	7,  // 8: ocp.currency.v1.Mint.vm_metadata:type_name -> ocp.currency.v1.VmMetadata
	8,  // 9: ocp.currency.v1.Mint.launchpad_metadata:type_name -> ocp.currency.v1.LaunchpadMetadata
	11, // 10: ocp.currency.v1.Mint.created_at:type_name -> google.protobuf.Timestamp
	12, // 11: ocp.currency.v1.VmMetadata.vm:type_name -> ocp.common.v1.SolanaAccountId
	12, // 12: ocp.currency.v1.VmMetadata.authority:type_name -> ocp.common.v1.SolanaAccountId
	12, // 13: ocp.currency.v1.VmMetadata.omnibus:type_name -> ocp.common.v1.SolanaAccountId
	12, // 14: ocp.currency.v1.LaunchpadMetadata.currency_config:type_name -> ocp.common.v1.SolanaAccountId
	12, // 15: ocp.currency.v1.LaunchpadMetadata.liquidity_pool:type_name -> ocp.common.v1.SolanaAccountId
	12, // 16: ocp.currency.v1.LaunchpadMetadata.seed:type_name -> ocp.common.v1.SolanaAccountId
	12, // 17: ocp.currency.v1.LaunchpadMetadata.authority:type_name -> ocp.common.v1.SolanaAccountId
	12, // 18: ocp.currency.v1.LaunchpadMetadata.mint_vault:type_name -> ocp.common.v1.SolanaAccountId
	12, // 19: ocp.currency.v1.LaunchpadMetadata.core_mint_vault:type_name -> ocp.common.v1.SolanaAccountId
	6,  // 20: ocp.currency.v1.GetMintsResponse.MetadataByAddressEntry.value:type_name -> ocp.currency.v1.Mint
	2,  // 21: ocp.currency.v1.Currency.GetAllRates:input_type -> ocp.currency.v1.GetAllRatesRequest
	4,  // 22: ocp.currency.v1.Currency.GetMints:input_type -> ocp.currency.v1.GetMintsRequest
	3,  // 23: ocp.currency.v1.Currency.GetAllRates:output_type -> ocp.currency.v1.GetAllRatesResponse
	5,  // 24: ocp.currency.v1.Currency.GetMints:output_type -> ocp.currency.v1.GetMintsResponse
